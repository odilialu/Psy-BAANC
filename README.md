...
2. **Format videos as needed for good mouse coordinate tracking:**
...
3. **Export coordinates:**
    ...
    Use DeepLabCut, Biobserve, or Ethovision to export mouse body and/or nose coordinates as csv from video files.
...
4. **Format data:**
    ...
    Create a folder for each experiment (e.g., `OFT_acute`, `OFT_persistent`, `EPM_acute`, `EPM_persistent`, `NOE_acute`, `NOE_persistent`, `SIT_acute`, `SIT_persistent`).
